...
namespace LAB_07_ADS
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (bol)
            {
                Console.WriteLine("Выберете режим работи приложения: \n Auto - подготовленая програма для проверки \n Manual - ручной ввод информации \n End - конец работы приложения ");
        ...
        public static void manunalUsing()
        {
            ...
            while (bol)
            {
                Console.WriteLine("Набор команд для управления: \n Create - создать хеш-таблицу \n Add - добавить клиента (Пример: Artem Kononenko,3,classic,27.May.2022,5 ) \n Remove - удалить клиента (Пример: 123456) \n Find - поиск клиента (Пример: 123456 ) \n Show - показать таблицу\n allDeparturesAtThisDate - все клиенты которые выежают в выбраную вами дату ( Пример: 28.May.2022 ) \n Exit - выход из режима ");
                string command = Console.ReadLine();
                switch (command)
                {
                    case "Create":
